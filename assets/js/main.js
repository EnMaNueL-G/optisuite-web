...
const VALID_PAGES = ['home','tools','windows','android','macos','linux','updates','categories','community','about','toolkit','office-plus','optifleet','optiplay','opticert','optigrab','optidocs','neuralmix'];
